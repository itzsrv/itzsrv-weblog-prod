# Stories
<!--
This page contains only content that has the tag **stories**.

This works thanks to this code:

```jsx
<FeedItems filterByTags={['stories']} />
```
...
## Projects (any content with the "stories" tag):
-->

Considering all the negativities prevailing around, this is a page for curated positive stories and excerpts, some of my own creations and some from my favourite writers and novels. 
<FeedItems filterByTags={['story']} />
